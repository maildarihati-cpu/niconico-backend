...
import type Myob from '../../src/modules/myob'
import type Hero from '../../src/modules/hero'
import type StoreLocation from '../../src/modules/store-location'
...
declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    ...
    'myob': InstanceType<(typeof Myob)['service']>,
    'hero': InstanceType<(typeof Hero)['service']>,
    'storeLocation': InstanceType<(typeof StoreLocation)['service']>
  }
}